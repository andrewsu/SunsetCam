...
echo "bash /home/pi/SunsetCam/SunsetCam.sh -e 1 -d 1 -c 21 >> $LOG_FILE" | at -t $executionTime
...
#echo "echo '`date`: Executing photo capture' >> /home/pi/SunsetCam/log" | at -t $executionTime
echo "bash /home/pi/SunsetCam/SunsetCam.sh -i 10 -n 240 -c 3 -e 1 -d 1 >> $LOG_FILE" | at -t $executionTime
